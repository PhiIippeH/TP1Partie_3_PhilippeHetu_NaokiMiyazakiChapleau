...
public class FacturesTest {
	...
	public void lireFicTest() {
		...
		// facturesTest.plats.addAll(Arrays.asList("Poutine 10.5","Frites
		// 2.5","Repas_Poulet 15.75"));
		// facturesTest.commandes.addAll(Arrays.asList("Roger Poutine 1","Céline
		// Frites 2","Céline Repas_Poulet 1"));
		// facturesTest.lignes.addAll(Arrays.asList("Clients
		// :","Roger","Céline","Steeve","Plats :","Poutine 10.5","Frites
		// 2.5","Repas_Poulet 15.75","Commandes :","Roger Poutine 1","Céline
		// Frites 2","Céline Repas_Poulet 1","Fin"));
